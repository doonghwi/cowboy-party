...
class Config {
  ...
  // ── 봇 자체전(랭킹 활력) ──────────────────────────────────────────────
  /// **사람이 어딘가에서 게임 중일 때만** 봇 3~5명이 비공개 방에서 자기들끼리
  /// 한 판 하고 승자가 주간 랭킹 점수를 얻는다(랭킹이 실제 활동과 비례해
  /// 살아있어 보이게). 사람이 아무도 게임 중이 아니면 봇 점수는 오르지 않는다.
  static const botWarMinPlayers = 3;
  static const botWarMaxPlayers = 5;

  /// 판 사이 휴식(점수 인플레 방지 — 동시 1판 + 이 간격).
  static const botWarRestMinMs = 30000;
  static const botWarRestMaxMs = 90000;

  /// "사람 게임 중" 감시 주기.
  static const botWarPollMs = 15000;
